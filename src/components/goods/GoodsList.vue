...
export default {
    ...
    methods:{
        getGoodsList(){
            //获取商品列表
            this.$http.get("goods/goodslist?pageindex="+this.pageindex+"&pagesize="+this.pagesize).then(result=>{
        ...
        goDetail(id){
            ...
            // 其中：this.$router 是一个路由导航参数，用它 可以方便的 使用 JS 代码，实现路由的 前进、后退、跳转到新的 URL 地址 
